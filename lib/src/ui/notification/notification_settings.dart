    ...
    return CustomPage(
      ...
      child: FutureBuilder(
        ...
        builder: (context, snapshot) {
          if (!snapshot.hasData) return LoadingIndicator(EdgeInsets.all(16));
          if (snapshot.hasError)
            return Center(child: Text("Cannot load settings"));

          // Make a copy
          if (_copy == null) _copy = snapshot.data;
          ...
          return Container(
            ...
            child: ListView(children: <Widget>[
              SettingsSection(
                ...
                settingsChildren: [
                  ...
                  SettingsSelectionList<int>(
                    ...
                    dismissTitle: 'Cancel',
                    caption: _minWindowList[_map_1(_minWindowList.indexWhere(
                            (element) => element.value == _copy.minWindow))]
                        .text,
                  ...
                  SettingsSelectionList<int>(
                    ...
                    titleStyle: TextStyle(fontSize: 16),
                    dismissTitle: 'Cancel',
                    caption: _maxNumberList[_map_1(_maxNumberList.indexWhere(
                            (element) => element.value == _copy.maxPerDay))]
                        .text,
                    icon: new SettingsIcon(
              ...
              _switchListTile(
                  ...
                  onTap: () {
                    setState(() =>
                        _copy.allowLiveIfCalendar = !_copy.allowLiveIfCalendar);
                  },
              ...
              SettingsInputField(
                ...
                caption: _copy.workSSID == null ? "Not set" : _copy.workSSID,
                onPressed: (value) {
